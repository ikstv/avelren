...
RCLONE_CONFIG="$rclone_config" RESTIC_REPOSITORY="$RESTIC_REPOSITORY_URL" restic forget --password-file "$password_file" --tag postgres --keep-daily 7 --keep-weekly 4 --keep-monthly 3 --prune >/dev/null
